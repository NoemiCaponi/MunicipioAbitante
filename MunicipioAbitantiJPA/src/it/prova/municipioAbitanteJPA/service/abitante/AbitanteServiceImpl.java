...
public class AbitanteServiceImpl implements AbitanteService {
	...
	@Override
	public List<Abitante> cercaTuttiGliAbitantiPerCognome(String cognome) throws Exception {
	...
	@Override
	public List<Abitante> cercaCodiceMunicipioCheIniziaCon(String codice) throws Exception {
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
